  ...
  return (
    <div className="p-6 space-y-6 min-h-screen">
      ...
      <div className="flex flex-col space-y-2 mb-4 p-4 bg-amber-50 text-amber-900 border border-amber-200 rounded-md">
        ...
        <p className="text-sm">
          This insights page shows simulated snapshot data for layout purposes. For live operational intelligence and real insights, please visit the <a href="/resort-360" className="underline font-bold text-amber-700">Manager Resort 360</a> page.
        </p>
      </div>
